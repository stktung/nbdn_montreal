...
namespace nothinbutdotnetstore.web.core
{
    public class BasicViewRegistry : ViewRegistry
    {
        ...
        public static ViewFactory view_factory = (path,type) => BuildManager.CreateInstanceFromVirtualPath(path, type);

        public BasicViewRegistry(IDictionary<Type, Type> view_models_to_views)
        {
